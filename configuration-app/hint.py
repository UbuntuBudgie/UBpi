...
XRDP_BUTTON = "Enable / disable Budgie Pi's XRDP access. This should not be used when Gnome's RDP is enabled."
XRDP_NOT_INSTALLED = "Budgie Pi provides an alternative xrdp option.\nThis will install the xrdp package."
SSH_BUTTON = "Enable or disable SSH access (Remote Login) through Budgie Control Center Sharing options."
